...
public class Zcs_scatter {
     ...
     */
    public static int cs_scatter(Zcs A, int j, Complex beta, int[] w, Complex[] x, int mark, Zcs C, int nz) {
        int i, p;
        int Ap[], Ai[], Ci[];
        Complex[] Ax;
        if (!Zcs_util.CS_CSC(A) || w == null || !Zcs_util.CS_CSC(C))

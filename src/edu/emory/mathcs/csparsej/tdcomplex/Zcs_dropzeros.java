 ...
 *
 */
public class Zcs_dropzeros {

    private static class Cs_nonzero implements Zcs_ifkeep {
        @Override
        public boolean fkeep(int i, int j, Complex aij, Object other) {
            return (aij.getReal() != 0 && aij.getImaginary() != 0);
        }
    }
     ...
     */
    public static int cs_dropzeros(Zcs A) {
        return (Zcs_fkeep.cs_fkeep(A, new Cs_nonzero(), null)); /* keep all nonzero entries */
    }

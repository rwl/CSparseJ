...
public class Zcs_permute {
     ...
     */
    public static Zcs cs_permute(Zcs A, int[] pinv, int[] q, boolean values) {
        ...
        Ai = A.i;
        Ax = A.x;
        C = Zcs_util.cs_spalloc(m, n, Ap[n], values && Ax != null, false); /* alloc result */
        Cp = C.p;
        Ci = C.i;
        Cx = C.x;
        for (k = 0; k < n; k++) {

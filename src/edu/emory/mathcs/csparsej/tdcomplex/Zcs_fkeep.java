...
public class Zcs_fkeep {
     ...
     */
    public static int cs_fkeep(Zcs A, Zcs_ifkeep fkeep, Object other) {
        ...
        for (j = 0; j < n; j++) {
            ...
            for (; p < Ap[j + 1]; p++) {
                if (fkeep.fkeep(Ai[p], j, Ax != null ? Ax[p] : Complex.ONE, other)) {
                    if (Ax != null)
        ...
        Ap[n] = nz; /* finalize A */
        Zcs_util.cs_sprealloc(A, 0); /* remove extra space from A */
        return (nz);
    }
